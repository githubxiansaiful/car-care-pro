  ...
  return (
    <header className="border-b border-gray-300 bg-white">
      <div className="container">
        <nav className="flex items-center justify-between py-4  relative transition-all">

          <Link href="/"><Image src="/assets/logo.png" width={150} height={40} alt="Car Care Pro"></Image> </Link>
